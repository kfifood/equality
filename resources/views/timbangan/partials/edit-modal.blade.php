    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select class="form-select" id="jenis_alat_ukur" name="jenis_alat_ukur">
                ...
                <option value="Timbangan" {{ old('jenis_alat_ukur', $timbangan->jenis_alat_ukur) == 'Timbangan' ? 'selected' : '' }}>Timbangan</option>
            </select>
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="kapasitas" name="kapasitas"
                   value="{{ old('kapasitas', $timbangan->kapasitas) }}" placeholder="Contoh: 30 kg, 5000 g">
        </div>
    </div>
</div>
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="certificate_number" name="certificate_number"
           value="{{ old('certificate_number', $timbangan->certificate_number) }}" placeholder="Contoh: CERT-2024-001">
</div>
